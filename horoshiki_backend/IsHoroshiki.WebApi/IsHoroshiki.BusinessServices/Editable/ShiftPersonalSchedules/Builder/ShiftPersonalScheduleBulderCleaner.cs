...
{
    /// <summary>
    /// График расписания для отдела Производство подотдела уборка
    /// </summary>
    internal class ShiftPersonalScheduleBulderCleaner : ShiftPersonalScheduleBulderByType
    {
        #region Конструктор
        ...
        public ShiftPersonalScheduleBulderCleaner(UnitOfWork unitOfWork, IShiftPersonalScheduleDataModel model)
