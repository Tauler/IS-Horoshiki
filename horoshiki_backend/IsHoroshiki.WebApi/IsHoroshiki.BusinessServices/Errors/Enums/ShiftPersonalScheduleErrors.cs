...
namespace IsHoroshiki.BusinessServices.Errors.Enums
{
    ...
    public enum ShiftPersonalScheduleErrors
    {
        ...
        /// <summary>
        /// Для существующего графика смены на дату указана дата, отличная от сохраненной даты в БД!
        /// </summary>
        UpdateMistakeDate,

        /// <summary>
        /// Для существующего графика смены на дату указан тип смены, отличный от типа сохраненного в БД!
        /// </summary>
        UpdateMistakeType,
